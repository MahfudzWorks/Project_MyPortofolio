...
function Experience() {
  return (
    ...
    >
      ...
      <div className="relative flex flex-col md:flex-row md:justify-center text-center md:text-left mt-4 md:gap-8">
        <ProjectCard>
      ...
      <div className="relative flex flex-col md:flex-row md:justify-center text-center mt-4 md:gap-8">
        <ProjectCard>
          <div className="hidden w-120 md:flex md:justify-end">
            <h3 className="py-5 ">08/2024 - 12/2024</h3>
          </div>
